...
public class DashboardService {
    ...
    public DashboardStatsResponse getUserDashboardStats(String userId) {
        ...
        // Count resumes
        long resumeCount = resumeRepository.countByUser_Id(userId);
        
        // Count applications from activity log
        long appliedCount = userActivityRepository.countByUser_IdAndActivityType(userId, "career_application");
