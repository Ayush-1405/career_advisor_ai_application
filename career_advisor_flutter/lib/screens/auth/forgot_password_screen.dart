...
class _ForgotPasswordScreenState extends ConsumerState<ForgotPasswordScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      // Use custom URL scheme so the link opens the app directly
      // The backend will redirect to: careerapp://reset-password?token=...&email=...
      final redirectBaseUrl = '$baseUrl/reset-password-redirect';
